/*THIS CODE WAS MY OWN WORK, IT WAS WRITTEN WITHOUT CONSULTINGCODE WRITTEN BY OTHER STUDENTS. Deidra Papakostas*/
...
public class Sorting_1 {
	...
	public static void MergeSortNonRec(long[] a) {
		long[] aux1 = a;
		long[] aux2 = new long[a.length];
		for(int pass = 1; pass < a.length; pass *= 2){
			for(int beg = 0; beg < a.length; beg += pass * 2){
				merge(aux1, aux2, beg, (beg + pass) - 1, beg + (2 * pass) - 1);
			}
			aux2 = aux1;
		}	
	}//MergeSortNonRec()
